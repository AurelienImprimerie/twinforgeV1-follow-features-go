...
class VoiceFeedbackTranscriptionService {
  ...
  async transcribeAudio(audioBlob: Blob): Promise<TranscriptionResult> {
    ...
    try {
      ...
      // CRITICAL FIX: Get authenticated user ID for edge function
      ...
      formData.append('userId', user.id); // CRITICAL: Required by edge function

      logger.debug('VOICE_TRANSCRIPTION', 'Sending transcription request', {
        userId: user.id,
